...
emulation/ input artifact is regenerated, with the reason.
...
| emulation/quest.blocks.split    | 1d3baaf6487a8e3f | a5efa05f59e7af67 |
| emulation/quest.ir2.book        | b510a58bbfa05ba5 | (regenerated; headers + 64 text lines) |
| emulation/quest.ir2.stock       | fa0ab9ba7442b9de | (regenerated) |
...
| emulation/quest.synclist.split  | 42bde6c45c24658c |
| emulation/quest.pushmap.M4      | b89536597005f304 |
| emulation/quest.addrbook        | e6fde2c246630e0e |

Full digests: `sha256sum Disassembled/* Work/emulation/quest.*` on branch
...
|---|---|---|
| emulation/quest.synclist.p27    | af1be42f5831fb2c | NEW — the sync list of record for the ir 3 artifacts (13,510 entries) |
| emulation/quest.ir2.book        | 1dc6356a2b45cc06 | regenerated: 2,271 clusters folded, embeds 6,258 |
| emulation/quest.ir2.stock       | d5e4cb13653c0b29 | regenerated |
| emulation/quest.synclist.split  | 42bde6c45c24658c | unchanged (identity; all-emulated runs) |
...
| file | sha256 (first 16) | note |
|---|---|---|
| emulation/quest.ir2.book        | 294f81d3ef779121 | regenerated ir 4: 987 rt_call, embeds 2,322, 2,273 assert, 11,442 goto |
| emulation/quest.ir2.stock       | 1cf12f3393744fdd | regenerated ir 4: 987 rt_call, embeds 4,201 |
| emulation/quest.synclist.p27    | af1be42f5831fb2c | UNCHANGED — still the list of record (rt_call adds/removes no block) |
...
Regeneration command (from Work/emulation; identical inputs, `--rt-slice 3
...
| file | sha256 (first 16) | note |
|---|---|---|
| emulation/quest.ir2.book        | 281fd5010ad4e8b3 | regenerated ir 5: 652 string statements, embeds 1,670, 987 rt_call, 2,273 assert, 11,442 goto |
| emulation/quest.ir2.stock       | 1122b9852cd2ab76 | regenerated ir 5: 652 string statements, embeds 3,549 |
| emulation/quest.synclist.p27    | af1be42f5831fb2c | UNCHANGED — still the list of record (no block added or removed; the min diamonds stay) |
...
Regeneration command (from Work/emulation; `--strings-slice 3` is the ir 5
artifact of record):
...
6). The artifact itself is regenerated by (from Work/emulation/tools):
...
| emulation/quest.blocks.split  | ba30a84139a7d2f4 | 26 successor lines; synclist.split byte-identical |
...
| file | sha256 (first 16) | note |
|---|---|---|
| emulation/quest.ir2.book        | 1be3aa29c8b2332a | regenerated ir 5: 649 string statements (17 sites corrected: 3 refuse, 14 re-rendered), embeds 1,673; blocks line = ba30a841… |
| emulation/quest.ir2.stock       | 497c49b47ee85b83 | regenerated ir 5: 649 string statements, embeds 3,552 |
...
| emulation/quest.synclist.p27    | af1be42f5831fb2c | UNCHANGED |
...
| file | sha256 (first 16) | note |
|---|---|---|
| emulation/quest.ir2.book        | 90089ef497ff644a | ir 5 slice 6: 1,593 string statements (649 P31 + 944 P32), embeds 729, 987 rt_call, 2,273 assert, 11,442 goto |
| emulation/quest.ir2.stock       | 638281f6c0b43d61 | ir 5 slice 6: 1,593 string statements, embeds 2,608 |
...
Regeneration command (from Work/emulation; `--strings-slice 6` is the
...
| file | sha256 (first 16) | note |
|---|---|---|
| emulation/quest.ir2.book        | e2f18f144c195da4 | ir 6 slice 7: 1,822 string statements (649 P31 + 944 P32 + 229 P33-B), embeds 557, WCMV/WMSP/STASP embeds 0/0/0, 987 rt_call, 2,273 assert, 11,442 goto |
| emulation/quest.ir2.stock       | c4340b497ea16eda | ir 6 slice 7: embeds 2,436 |
| emulation/quest.arena           | 64ab09d44e343c36 | NEW: the arena layout — 57 twins t@<block>.<k>, 0x2000-word stride from 0x75000000, 8192 B provisional (5 exact); tools/arena.py from quest.strhooks |
| emulation/quest.strhooks        | 9cc8c96cbad2fd28 | regenerated: the provisional arena=/cap= columns removed (layout in quest.arena); pcs unchanged |
...
Regeneration (from Work/emulation; `--strings-slice 7` is the artifact of record):
