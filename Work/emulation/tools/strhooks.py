...
temp per claim — t@<block>.<k> — because every master temp gets its own
...
def main():
    ...
    out.append('# arena layout: quest.arena (tools/arena.py), one temp t@<block>.<k> per wmsp line (P33-B)')
