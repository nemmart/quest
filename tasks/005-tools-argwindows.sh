...
java -cp tools.jar ArgWindows "$ROOT/QUEST" QUEST ../Disassembled/quest.addrs ../Disassembled/quest.targets ../Work/emulation/quest.addrbook ../Disassembled/quest.dis /tmp/argmap.new /tmp/callsites.new
