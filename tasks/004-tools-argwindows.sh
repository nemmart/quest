...
java -cp tools.jar ArgWindows "$ROOT" QUEST ../Disassembled/quest.addrs ../Disassembled/quest.targets ../Work/c_src/quest.addrbook ../Disassembled/quest.dis /tmp/argmap.new /tmp/callsites.new
